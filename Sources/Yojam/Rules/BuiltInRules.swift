...
enum BuiltInRules {
    ...
    static let all: [Rule] = [
        ...
        Rule(id: UUID(uuidString: "550e8400-e29b-41d4-a716-44665544001b")!,
             name: "Discord Invite", matchType: .urlContains, pattern: "discord.com/invite/",
             targetBundleId: "com.hnc.Discord", targetAppName: "Discord",
             isBuiltIn: true, priority: 126),
        Rule(id: UUID(uuidString: "550e8400-e29b-41d4-a716-44665544001c")!,
             name: "Discord Invite (discord.gg)", matchType: .domainSuffix, pattern: "discord.gg",
             targetBundleId: "com.hnc.Discord", targetAppName: "Discord",
             isBuiltIn: true, priority: 127),
        ...
        Rule(id: UUID(uuidString: "550e8400-e29b-41d4-a716-44665544001a")!,
             name: "Notion (app.notion.com)", matchType: .domainSuffix, pattern: "app.notion.com",
             targetBundleId: "notion.id", targetAppName: "Notion",
