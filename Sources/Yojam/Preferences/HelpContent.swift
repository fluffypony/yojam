...
enum HelpText {
    ...
    enum Advanced {
        ...
        static let configFileChangeLocation = "Choose where Yojam writes and watches the live JSON config mirror."
        static let configFileResetLocation = "Use the default location in ~/Library/Application Support/Yojam/ again."
    ...
    enum Integrations {
        ...
        static let servicesMenu = "Highlight any URL in any Cocoa app, right-click, and choose Services > Open in Yojam. You can also assign a global keyboard shortcut in System Settings > Keyboard > Keyboard Shortcuts > Services.\n\nmacOS keeps its own list of which app provides each service. If the entry is missing or points at an old copy of Yojam, Repair asks macOS to rescan installed apps. The entry can also be switched off under System Settings > Keyboard > Keyboard Shortcuts > Services."
